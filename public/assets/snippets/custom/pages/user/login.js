        ...
        init: function() {
            l(), $("#m_login_signin_submit").click(function(e) {
                ...
                l.valid() && (a.addClass("m-loader m-loader--right m-loader--light").attr("disabled", !0),
                    ...
                    a.addClass('m-loader m-loader--right m-loader--light').html('Cargando Interfaz...').attr('disabled', true);
                        ...
                        error: function(e, t, r, s) {
                            setTimeout(function() {
                                a.removeClass("m-loader m-loader--right m-loader--light").attr("disabled", !1),
                                    i(l, "danger", "Nombre de usuario o contraseña incorrecta. Inténtalo de nuevo.")
                            }, 2e3)
                        }
                }))
