...
@section('content')
                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <a href="#" class="m-nav__link">
                            <span class="m-nav__link-text">BO-TXMW/SATEL</span>
                        </a>
                    </li>
                    <li class="m-nav__separator">-</li>
                    <li class="m-nav__item">
                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <div class='input-group' id='m_daterangepicker_2'>
                            <input type='text' id="filtro-fecha" class="form-control m-input" readonly  placeholder="Filtro Rango de Fecha"/>
    ...
    <div class="modal fade" id="listar-tareas" tabindex="-1" role="dialog" aria-labelledby="listarTareas" aria-hidden="true" style="display: none;">
...
@push('scripts')
    ...
    <script src="{{asset('js/dashboarBoTx.js')}}"></script>
    <script>



        $(document).ready(function () {
            var url ='{{route('BoTx.infoDash')}}';
            var urlLoadItems ='{{route('BoTx.tmp')}}';
            BoTx.dashBoardTareas(url,'','',urlLoadItems);
