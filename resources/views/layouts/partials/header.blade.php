                ...
                <div class="m-stack m-stack--ver m-stack--general">
                    <div class="m-stack__item m-stack__item--middle m-stack__item--center m-brand__logo">
                        <a href="{{route('home')}}" class="m-brand__logo-wrapper">
                            <img alt="" src="{{asset('assets/media/img/logo/logo.png')}}" width="100px" />
                        </a>
                    </div>
                                ...
                                <div class="m-dropdown__wrapper">
                                    ...
                                    <div class="m-dropdown__inner">
                                        <div class="m-dropdown__header m--align-center" style="background: url({{asset('assets/app/media/img/misc/quick_actions_bg.jpg')}}); background-size: cover;">
                                            <span class="m-dropdown__header-title">Modulos Favoritos</span>
                                            <span class="m-dropdown__header-subtitle">Acceso Rapido</span>
                                        </div>
                            ...
                            <li class="m-nav__item m-topbar__user-profile m-topbar__user-profile--img m-dropdown m-dropdown--medium m-dropdown--arrow m-dropdown--header-bg-fill m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light"
                                ...
                                <a href="#" class="m-nav__link m-dropdown__toggle">
                                    <span class="m-topbar__userpic">
                                        <img src="{{asset('img/users/'.currentUser()->photo)}}" alt="" />
                                    </span>
                                </a>
                                <div class="m-dropdown__wrapper">
                                    <span class="m-dropdown__arrow m-dropdown__arrow--right m-dropdown__arrow--adjust"></span>
                                        ...
                                        <div class="m-dropdown__header m--align-center" style="background: url({{asset('assets/app/media/img/misc/user_profile_bg.jpg')}}); background-size: cover;">
                                            <div class="m-card-user m-card-user--skin-dark">
                                                ...
                                                <div class="m-card-user__details">
                                                    <span class="m-card-user__name m--font-weight-500">{{currentUser()->name}}</span>
                                                    <a href="" class="m-card-user__email m--font-weight-300 m-link">{{currentUser()->email}}</a>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <ul class="m-nav m-nav--skin-light">
                                                    ...
                                                    <li class="m-nav__item">
                                                        <a href="#" class="m-nav__link">
                                                            ...
                                                            <span class="m-nav__link-text">Soprte</span>
                                                        </a>
                                                    </li>
                                                    <li class="m-nav__separator m-nav__separator--fit">
                                                    </li>
